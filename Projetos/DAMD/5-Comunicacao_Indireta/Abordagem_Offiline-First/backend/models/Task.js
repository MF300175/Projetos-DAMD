...
class Task {
  ...
  static toApiFormat(task) {
    ...
    return {
      // Flutter fromApiMap espera: id como int (server_id) na linha 164
      // Mas também precisa do client_id como string
      ...
      is_completed: task.completed === 1, // Flutter espera is_completed (linha 167)
