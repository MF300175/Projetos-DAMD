 ...
 * Baseado no roteiro do professor
 */
class TaskStorage {
    constructor() {
        this.tasks = new Map();
        this.subscribers = new Set();
        this.users = new Map(); // Adicionado para autenticação
        this.chatSessions = new Set(); // Adicionado para chat
        this.createTestUser();
    }
    ...
    createTestUser() {
        this.users.set('teste@exemplo.com', {
    ...
    getChatSessions() {
        return Array.from(this.chatSessions);
    }

    broadcastToChat(message, excludeSession = null) {
